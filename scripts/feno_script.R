...
feno.circ.zoo <- circular(zoo$daysangles, units = "degrees", 
                          template = "none", modulo = "2pi")
...
plot(feno.circ.zoo, units = "radians", axes = FALSE, shrink = 1, stack = TRUE, 
     pch = 16, bins = 365, cex = 0, rotation = "clock", zero = pi/2)

# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.zoo, axes = FALSE, bins = 12, col = "#F19E14", 
                    cex = 0.0, prop =1.3, add = TRUE, zero = pi/2, rotation = "clock")

# Adicionar rótulos aos eixos com tamanho aumentado
axis.circular(at = circular(sort(seq(0, 11/6*pi, pi/6), decreasing = TRUE)), 
              c(labels = c("M", "J", "J", "A", "S", "O", "N", "D", "J", "F", 
                           "M","A")), 
              cex = 2.0)
...
# Converter os ângulos em dados circulares
feno.circ.anemo <- circular(anemo$daysangles, units = "degrees", 
                            template = "none", modulo = "2pi")
...
# Plotar o gráfico circular
plot(feno.circ.anemo, units = "radians", axes = FALSE, shrink = 1, stack = TRUE, 
     pch = 16, bins = 365, cex = 0, rotation = "clock", zero = pi/2)

# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.anemo, axes = FALSE, bins = 12, col = "#5B7C91", 
                    cex = 0.0, prop =1.3, add = TRUE, zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.auto <- circular(auto$daysangles, units = "degrees", 
                           template = "none", modulo = "2pi")
...
# Plotar o gráfico circular
plot(feno.circ.auto, units = "radians", axes = FALSE, shrink = 1, stack = TRUE, 
     pch = 16, bins = 365, cex = 0, rotation = "clock", zero = pi/2)

# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.auto, axes = FALSE, bins = 12, col = "#9F4147", 
                    cex = 0.0, prop =1.3, add = TRUE, zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.zoofilia <- circular(zoofilia$daysangles, units = "degrees", 
                               template = "none", modulo = "2pi")
...
# Plotar o gráfico circular
plot(feno.circ.zoofilia, units = "radians", axes = FALSE, shrink = , 
     stack = TRUE, pch = 16, bins = 365, cex = 0, rotation = "clock")

# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.zoofilia, axes = FALSE, bins = 12, col = "#E86652", 
                    cex = 0.0, prop = 1.3, add = TRUE, zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.anemofilia <- circular(anemofilia$daysangles, units = "degrees", 
                                 template = "none", modulo = "2pi")
...
# Plotar o gráfico circular
plot(feno.circ.anemofilia, units = "radians", axes = FALSE, shrink = , 
     stack = TRUE, pch = 16, bins = 365, cex = 0.0, rotation = "clock")

# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.anemofilia, axes = FALSE, bins = 12, 
                    col = "#F8AF77", cex = 0.0, prop = 1.3, add = TRUE, 
                    zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.sempreverde <- circular(sempreverde$daysangles, units = "degrees", 
                                  template = "none", modulo = "2pi")
...
# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.sempreverde, axes = FALSE, bins = 12, 
                    col = "#C3E747", cex = 0.0, prop = 1.3, add = TRUE, 
                    zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.semidecidua <- circular(semidecidua$daysangles, units = "degrees", 
                                  template = "none", modulo = "2pi")
...
# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.semidecidua, axes = FALSE, bins = 12, 
                    col = "#71B481", cex = 0.0, prop = 1.3, add = TRUE, 
                    zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.decidua <- circular(decidua$daysangles, units = "degrees", 
                              template = "none", modulo = "2pi")
...
# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.decidua, axes = FALSE, bins = 12, col = "#75774E", 
                    cex = 0.0, prop = 1.3, add = TRUE, zero = pi/2, 
                    rotation = "clock")
...
watson.williams.test(list(rad(feno.circ.sempreverde), rad(feno.circ.semidecidua), 
                          rad(feno.circ.decidua)))
...
# Converter os ângulos em dados circulares
feno.circ.ssempreverde <- circular(ssempreverde$daysangles, units = "degrees", 
                                   template = "none", modulo = "2pi")
...
# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.ssempreverde, axes = FALSE, bins = 12, 
                    col = "#C3E747", cex = 0.0, prop = 1.3, add = TRUE, 
                    zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.ssemidecidua <- circular(ssemidecidua$daysangles, units = "degrees", 
                                   template = "none", modulo = "2pi")
...
# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.ssemidecidua, axes = FALSE, bins = 12, 
                    col = "#71B481", cex = 0.0, prop = 1.3, add = TRUE, 
                    zero = pi/2, rotation = "clock")
...
# Converter os ângulos em dados circulares
feno.circ.sdecidua <- circular(sdecidua$daysangles, units = "degrees", 
                               template = "none", modulo = "2pi")
...
# Plotar a rosa dos ventos
circular::rose.diag(feno.circ.sdecidua, axes = FALSE, bins = 12, 
                    col = "#75774E", cex = 0.0, prop = 1.3, add = TRUE, 
                    zero = pi/2, rotation = "clock")
...
# O teste de Watson-Williams compara três amostras circulares
watson.williams.test(list(rad(feno.circ.ssempreverde), rad(feno.circ.ssemidecidua), 
                          rad(feno.circ.sdecidua)))
...
gg_duracao_frutos <- ggplot(
  duracao_frutos, aes(x = IN, y = Species, xend = FI, yend = reorder(
    Species, Dispersion), group = Dispersion, color = factor(Dispersion))) +
  ...
  scale_color_manual(values = c("1" = "#F19E14", "2" = "#5B7C91", "3" = "#9F4147", 
                                "4" = "#EF8F81", "5" = "#71B481"),
                     labels = c("Anemocoria", "Anemo+Auto", "Autocoria", 
                                "Zoo+Auto", "Zoocoria")) +  
...
ggsave("duracao_frutos.jpg", plot = gg_duracao_frutos, width = 12, 
       height = 8, dpi = 300)
...
gg_duracao_flores <- ggplot(
  duracao_flores, aes(x = IN, y = Species, xend = FI, yend = reorder(
    Species, Dispersion), group = Dispersion, color = factor(Dispersion))) +
  geom_segment(aes(group = Species)) +
  geom_point(aes(x = IN, y = Species, color = reorder(Species, Dispersion))) +  
  geom_point(aes(x = FI, y = Species, color = reorder(Species, Dispersion))) +
...
gg_duracao_queda_foliar1 <- ggplot(
  duracao_queda_foliar1, aes(x = IN, y = Species, xend = FI, yend = reorder(
    Species, Dispersion), group = Dispersion, color = factor(Dispersion))) +
  geom_segment(aes(group = Species)) +
  geom_point(aes(x = IN, y = Species, color = reorder(Species, Dispersion))) +  
  geom_point(aes(x = FI, y = Species, color = reorder(Species, Dispersion))) +
...
ggsave("duracao_queda_foliar1.jpg", plot = gg_duracao_queda_foliar1, 
       width = 12, height = 8, dpi = 300)

# Seu código para criar o gráfico
gg_duracao_queda_foliar2 <- ggplot(
  duracao_queda_foliar2, aes(x = IN, y = Species, xend = FI, yend = reorder(
    Species, Dispersion), group = Dispersion, color = factor(Dispersion))) +
  geom_segment(aes(group = Species)) +
  geom_point(aes(x = IN, y = Species, color = reorder(Species, Dispersion))) +  
  geom_point(aes(x = FI, y = Species, color = reorder(Species, Dispersion))) +
...
ggsave("duracao_queda_foliar2.jpg", plot = gg_duracao_queda_foliar2, 
       width = 12, height = 8, dpi = 300)
...
# Seu código para criar o gráfico
gg_duracao_brotamento1 <- ggplot(
  duracao_brotamento1, aes(x = IN, y = Species, xend = FI, yend = reorder(
    Species, Dispersion), group = Dispersion, color = factor(Dispersion))) +
  geom_segment(aes(group = Species)) +
  geom_point(aes(x = IN, y = Species, color = reorder(Species, Dispersion))) +  
  geom_point(aes(x = FI, y = Species, color = reorder(Species, Dispersion))) +
...
# Salvar o gráfico em um arquivo JPEG
ggsave("duracao_brotamento1.jpg", plot = gg_duracao_brotamento1, width = 12, 
       height = 8, dpi = 300)

gg_duracao_brotamento2 <- ggplot(
  duracao_brotamento2, aes(x = IN, y = Species, xend = FI, yend = reorder(
    Species, Dispersion), group = Dispersion, color = factor(Dispersion))) +
  geom_segment(aes(group = Species)) +
...
# Salvar o gráfico em um arquivo JPEG
ggsave("duracao_brotamento2.jpg", plot = gg_duracao_brotamento2, width = 12, 
       height = 8, dpi = 300)
