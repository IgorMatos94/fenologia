...
#fragments in the Corumbataí River Basin, São Paulo based on deciduousness, dispersion and 
...
feno <- readr::read_csv2(here::here("dados.csv"))
...
traits <- readr::read_csv(here::here("disp-poll_new.csv"))

duracao_frutos <- readr::read_csv(here::here("duracao_frutos.csv"))

duracao_flores <- readr::read_csv(here::here("duracao_flores.csv"))

duracao_brotamento1 <- readr::read_csv(here::here("duracao_brotamento1.csv"))

duracao_brotamento2 <- readr::read_csv(here::here("duracao_brotamento2.csv"))

duracao_queda_foliar1 <- readr::read_csv(here::here("duracao_queda_foliar1.csv"))

duracao_queda_foliar2 <- readr::read_csv(here::here("duracao_queda_foliar2.csv"))
